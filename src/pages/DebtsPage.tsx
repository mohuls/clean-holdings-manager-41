    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-md z-10">
        ...
        <nav className="p-4">
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/debts" className="flex items-center p-2 rounded-lg bg-blue-50 text-blue-600">
      ...
      <div className="ml-64 p-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Client Debts</h1>
            <p className="text-gray-500">Manage clients with outstanding debts</p>
          </div>
        </div>
        
        <Card>
          <CardHeader>
            <CardTitle>Client Debts Management</CardTitle>
          </CardHeader>
          <CardContent>
            <p>Client debts management features will be implemented here.</p>
          </CardContent>
        </Card>
      </div>
    </div>
